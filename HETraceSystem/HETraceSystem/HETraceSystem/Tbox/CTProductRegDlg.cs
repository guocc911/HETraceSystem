...
{
    public partial class CTProductRegDlg : Form
    {
        ...
        private void ResetProductInfo()
        {
            try
            {
                ...
                this.cbModelT.DataSource = SystemUtils.getTboxModelList();
        ...
        private void btAdd_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtName.Text == null || this.txtName.Text.Length <1)
            {
                ...
                mdl.CHARGE_POWER = 0;
                mdl.PORT_NUM =0;
                mdl.ADAPTER_TYPE = "APP";
                mdl.PT_MODEL = (COMM.PtModel)this.cbModelT.SelectedIndex;//通信版本编号
        ...
        private void CTProductRegDlg_Load(object sender, EventArgs e)
        {
            try
            {
                ResetProductInfo();
        ...
        private void 查看产品信息ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            CTProductCfgDlg dlg = new CTProductCfgDlg();
        ...
        private void 删除产品信息ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int index = Convert.ToInt32(this.treeView1.SelectedNode.Tag);
