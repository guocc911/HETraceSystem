...
{
    public partial class DeliveryInfoDlg : Form
    {
        #region Fileds
        ...
        private void LoadTestData()
        {
            ...
            for (int i = 1; i < 100; i++)
            {
                ...
                item = String.Format("{0}{1:D6}{2}", "CP01PL", i, "01");
                mdl.SN = item;
        ...
        private void btOutPut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DictionaryEntry de in inputTable)
                {
                    ...
                    if (DeliveryItem((InventoryItemMDL)de.Value, pos))
                    {
        ...
        private bool DeliveryItem(InventoryItemMDL mdl,int seq)
        {
            try
            {
        ...
        private void DeliveryInfoDlg_Load(object sender, EventArgs e)
        {
            try
            {
